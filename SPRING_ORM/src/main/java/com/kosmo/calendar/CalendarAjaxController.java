...
import com.kosmo.calendar.GoogleCalendarService;
import com.kosmo.board.BoardVO;
import com.kosmo.calendar.CalendarVO;
...
//	@ResponseBody
	public List<Event> calendarEventList(CalendarVO calDto) {
...
//			com.google.api.services.calendar.model.Calendar calendar = service.calendars().get(calDto.getCalendarId()).execute();
	...
	//@ResponseBody
	public Map<String, Boolean> calendarEventAdd(CalendarVO calDto) {
	...
	@ResponseBody
	public Map<String, Boolean> calendarEventRemoveOne(@RequestBody CalendarVO calDto) {
	...
	@ResponseBody
	public Map<String, Boolean> calendarEventModify(@RequestBody CalendarVO calDto) {
