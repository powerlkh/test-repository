...
public class InsaCardParserForJava {
...
//			cellFontStyle.setColor(Font.COLOR_RED);
	...
	public static ArrayList<String> parseExcelForXlsx(File file) {
		...
		InsaCardParserForJava thisc = new InsaCardParserForJava();
		try {
	...
	public static <T extends Sheet, V extends Row> ArrayList<String> parsing(T sheet) {
		ArrayList<String> cellList = new ArrayList<String>();
		//row
		for (int r = startDataRow; r < endDataRow; r++) {
			V row   = (V)sheet.getRow(r);
			if (row != null) { 
