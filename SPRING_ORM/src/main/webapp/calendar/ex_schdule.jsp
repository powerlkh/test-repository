...
<script src="/calendar/js/jquery-3.1.1.min.js"></script>
<script src="/calendar/js/bootstrap.min.js"></script>
<link rel="stylesheet" href="/calendar/css/bootstrap.min.css">
<link rel="stylesheet" href="/calendar/css/bootstrap-theme.min.css">
<script type="text/javascript" src='/calendar/js/sweetalert.min.js?ver=1'></script>
<link rel="stylesheet" type="text/css" href='/calendar/css/sweetalert.css?ver=1.2'>
<script type="text/javascript" src="/calendar/js/stringBuffer.js"></script>
<script type="text/javascript" src="/calendar/js/calendar.js"></script>
<script type="text/javascript" src="/calendar/js/calendarSchdule.js"></script>
<style type="text/css">
thead {
	text-align: center;
}
